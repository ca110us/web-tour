...
$(document).ready(function() {
    ...
    $("#next-page").click(function(event) {
        ...
        findUsers(currentview, currentpage + 1);
    })
...
function findUsers(userType, page) {
    $.post('index.php?controller=user&action=findUsers', { userType: userType, page: page }, function(data) {
