<?php require 'common/admin.header.html.php'; ?>
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-4">
          <div class="addUser justify-content-end"  <?php if($currentRole!=='admin'){printf('hidden="hidden"');}?>>
            <button type="button" class="btn btn-dark mt-4 mb-4 float-right" data-toggle="modal" data-target="#AddUserModal">添加用户</button>
          </div>
        </div>
      </div>
      <div class="row">
              ...
              <div class="tab-content" id="nav-tabContent">
                ...
                <div class="col d-flex justify-content-center">
                    <div class="btn-group mr-2" role="group">
                      <button id="last-page" type="button" class="btn btn-dark" data-view="all" data-page="1" onclick="">上一页</button>
                      <button id="next-page" type="button" class="btn btn-dark" data-view="all" data-page="1" onclick="">下一页</button>
                    </div>
                </div>
